...
obitos <- read_xlsx("C:\\Users\\hp pc\\Documents\\GitHub\\fernandaserpa\\OBITOS.xlsx")
...
Apesar de apresentar resultados há muito superados pela população brasileira urbana, ações necessárias para a redução da mortalidade como a implementação de ações intersetoriais:
1.Acesso à água de qualidade, 
2.Nutrição suficiente,
3.Prevenção diagnóstica, etc.

Perpassam por questões como o acesso às terras para as comunidades caçadoras/coletoras, à educação básica e respeito às formas tradicionais de existência.

## 
As comunidades indígenas ainda enfrentam preconceitos diversos no acesso à serviços básicos como documentação (representando o acesso à cidadania em suas várias formas: saúde especializada, educação, segurança, entre outros).

Também por sua extrema relação com o meio ambiente tão devastado e comprimido pelo avanço de agroculturas e exploração de recursos naturais.

## 
Avanços na atenção ao pré-natal e imunização das comunidades podem ser observados em contraste às deficiências no seguimento da atenção aos recém nascidos.

As dificuldades na definição da causa básica de óbito para comunidades que não estão cobertas o tempo todo por equipes de saúde e suas distâncias dos centros de especialidades. 
